...
export default function EditInvoiceFormEnglish({ invoice, onCloseModal }) {
    ...
    return (
        <Form type={onCloseModal ? "modal" : "regular"} onSubmit={handleSubmit}>
            ...
            <h1>Acceptance Result</h1>
            <FormColumn>
                <FormInputField label="The object corresponds to the agreements made in the order. All technical documents as of the date of acceptance have been handed over. The plant and equipment used by the contractor were handed over or handed over in proper condition.">
                    <Input type="checkbox" defaultChecked={invoice.all_docs_handed_over} name="all_docs_handed_over"/>
                </FormInputField>

                <FormInputField label="The object corresponds to the agreements made in the order, however">
                    <Input type="checkbox" defaultChecked={invoice.agreements_made_in_order_check} name="agreements_made_in_order_check"/>
                </FormInputField>

                {invoice.agreements_made_english.map((problem, index) => {
                    return (
                        <FormRow key={index}>
                            ...
                            <FormInputField label={problem.completion_by ? "Completion By" : "Payment / final payment until the work is completed"}>
                                <Input 
                                    type="text" 
            ...
            <FormRow>
                <FormInputField label="Acceptance is hereby declared. Dates subject to scheduling certainty start on trial operation">
                    <Input type="checkbox" defaultChecked={invoice.acceptance} name="acceptance"/>
                    <TextArea /> 
                </FormInputField>

                <FormInputField label="Target">
                    <TextArea defaultValue={invoice.target} name="target"/>
                </FormInputField>

                <FormInputField label="Actual">
                    <TextArea defaultValue={invoice.actual} name="actual"/>
                </FormInputField>
            </FormRow>

            <FormRow>
                <FormInputField label="Remarks">
            ...
            <h1>TR Protocol</h1>
            <h2>Task RET Retrofit</h2>
            
            <FormRow>
                <FormInputField label="Site Name">
                        <Input type="text" defaultValue={invoice.site_name} name="site_name"/> 
                </FormInputField>
                
                <FormInputField label="Type">
            ...
            <FormColumn>
                {Object.keys(invoice.old_tta).map((key) => {
                    ...
                    return (
                    <FormInputField key={key} label={isNameField ? "Old TTA" : key}>
                        <Input {...inputProps} />
                    </FormInputField>
                    );
                })}
            ...
            <FormRow>
                ...
                <FormInputField label="Manufacturer?">
                    <Input type="text" defaultValue={invoice.manufacturer} name="manufacturer"/> 
                </FormInputField>

                <FormInputField label="Dimensions (WxHxD)">
            ...
            <FormRow>
                ...
                <FormInputField label="HL covering">
                    <Input type="checkbox" defaultChecked={invoice.hl_grounding} name="hl_grounding"/> 
                </FormInputField>
            </FormRow>
            ...
            <FormInputField label="Agreements">
                {invoice.agreements.map((agreement, index) => (
                    <div key={index}>
                        <FormRow>
                            <FormInputField label="Agreement Type">
                                <Input 
                                    type="text" 
                            ...
                            <FormInputField label="Completion Date">
                                <Input 
                                    type="date" 
                        ...
                        <FormRow>
                            ...
                            <button type="button" onClick={() => removeAgreement(index)}>Remove</button>
                        </FormRow>

                        <hr />
                    </div>
                ))}
                <button type="button" onClick={addAgreement}>Add Agreement</button>

                <hr />

                <h3>The customer will charge the agreed deadline security amount</h3>

                <FormColumn>
                    <FormInputField label="The customer will charge the agreed contractual penalties">
                    ...
                    <FormInputField label="The object does not correspond to agreements">
